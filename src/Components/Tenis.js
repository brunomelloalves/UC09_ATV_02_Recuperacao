      ...
      <View>
        ...
        <Modal isVisible={getModal}>
          <View style={{ flex: 1, backgroundColor: 'white', borderRadius: 10, justifyContent: 'center', alignItems: 'center', padding: 10 }}>
            <Text style={{fontSize: 30, fontWeight: 'bold'}}>{props.nome2}</Text>
            <Image style={{width: 250, height: 250, borderRadius: 10, margin: 10}} source={{uri: props.imagem2 }} />
...
export default function Tenis({item}) {

    return(
        <View style={{width: 250, marginBottom: 5}}>            
            <View style={{height: 230, flex: 1, margin: 10}}>                        
